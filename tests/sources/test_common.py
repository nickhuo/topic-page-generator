...
def test_build_source_id_is_stable():
    assert build_source_id("https://example.com/a") == build_source_id("https://example.com/a")
...
def test_build_source_id_differs_per_url():
    assert build_source_id("https://example.com/a") != build_source_id("https://example.com/b")
