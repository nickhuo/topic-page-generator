...
def test_t0_contextual_openai():
    ...
    assert tier_for("https://openai.com/blog/x", primary_entity="GPT-5.5 by OpenAI") == "T0"


def test_t0_only_when_entity_matches():
    # openai.com is T0 only when the event is about OpenAI; otherwise T3.
    assert tier_for("https://openai.com/blog/x", primary_entity="FIFA World Cup") == "T3"


def test_t0_case_insensitive():
    assert tier_for("https://FIFA.com/news", primary_entity="fifa world cup 2026") == "T0"
